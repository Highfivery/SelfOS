...
const bridge: SelfosBridge = {
  ...
  storyQuoteCandidates: (input) => ipcRenderer.invoke(IpcChannels.storyQuoteCandidates, input),
  storyMineQuotes: (input) => ipcRenderer.invoke(IpcChannels.storyMineQuotes, input),
  storySetQuoteStatus: (input) => ipcRenderer.invoke(IpcChannels.storySetQuoteStatus, input),
  ...
  storyContinuityCheck: (input) => ipcRenderer.invoke(IpcChannels.storyContinuityCheck, input),
  storyManuscriptRead: (input) => ipcRenderer.invoke(IpcChannels.storyManuscriptRead, input),
  storyNewMaterial: (input) => ipcRenderer.invoke(IpcChannels.storyNewMaterial, input),
  storyFinishEdition: (input) => ipcRenderer.invoke(IpcChannels.storyFinishEdition, input),
  storyReopenBook: (input) => ipcRenderer.invoke(IpcChannels.storyReopenBook, input),
  storyAcceptMaterial: (input) => ipcRenderer.invoke(IpcChannels.storyAcceptMaterial, input),
  storyDeclineMaterial: (input) => ipcRenderer.invoke(IpcChannels.storyDeclineMaterial, input),
  storyContinuity: (input) => ipcRenderer.invoke(IpcChannels.storyContinuity, input),
  storyResolveContinuity: (input) => ipcRenderer.invoke(IpcChannels.storyResolveContinuity, input),
  storyLineEdit: (input) => ipcRenderer.invoke(IpcChannels.storyLineEdit, input),
  storyEditOutline: (input) => ipcRenderer.invoke(IpcChannels.storyEditOutline, input),
  storyEditTimeline: (input) => ipcRenderer.invoke(IpcChannels.storyEditTimeline, input),
  storySuggestTitles: (input) => ipcRenderer.invoke(IpcChannels.storySuggestTitles, input),
  storyRegenerateEssence: (input) => ipcRenderer.invoke(IpcChannels.storyRegenerateEssence, input),
  ...
  storyCastRegister: (input) => ipcRenderer.invoke(IpcChannels.storyCastRegister, input),
  storyConsent: (input) => ipcRenderer.invoke(IpcChannels.storyConsent, input),
  storySetConsent: (input) => ipcRenderer.invoke(IpcChannels.storySetConsent, input),
  ...
  storyPublishDiff: (input) => ipcRenderer.invoke(IpcChannels.storyPublishDiff, input),
  storyUnpublish: (input) => ipcRenderer.invoke(IpcChannels.storyUnpublish, input),
