          ...
          <Inline gap={3} align="start" justify="between">
            <Stack gap={1}>
              ...
              <Text size="sm" tone="secondary">
                Let SelfOS create short check-ins for you from what it’s learned — never re-asking
                what it already knows, always something new. Uses your AI allowance, and runs about
                once a day the app is open.
              </Text>
            </Stack>
            <Switch
                        ...
                        <Field label="How often">
                          {(props) => (
                            <Select
                              ...
                              value={t.cadence}
                              onChange={(e) =>
                                patchTarget(t.id, { cadence: e.target.value as AutoCheckinCadence })
                              }
                            >
                              {CADENCES.map((c) => (
