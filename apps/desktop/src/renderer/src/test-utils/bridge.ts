...
export function installMockBridge(overrides: Partial<SelfosBridge> = {}): SelfosBridge {
  const bridge: SelfosBridge = {
    ...
    testsNames: () => Promise.resolve(null),
    testsAdaptiveNames: () => Promise.resolve(null),
    testsAdaptiveState: () => Promise.resolve(null),
    testsAdaptiveStart: () => Promise.resolve(null),
    testsAdaptiveBank: () => Promise.resolve(null),
    testsAdaptiveSetArea: () => Promise.resolve(),
    testsAdaptiveLines: () => Promise.resolve({ ok: false, degraded: true }),
    testsAdaptiveProbe: () => Promise.resolve({ ok: true, done: true, degraded: false }),
    testsAdaptiveScenario: () => Promise.resolve({ ok: false, context: 'during', degraded: true }),
    testsAdaptiveTurn: () => Promise.resolve(),
    testsAdaptiveDeleteTurn: () => Promise.resolve(),
    testsAdaptiveSynthesize: () => Promise.resolve({ ok: true, state: null }),
    ...
    notesGetForMe: () => Promise.resolve(null),
    ...
    booksInviteContribution: () => Promise.resolve(null),
    booksRevokeContributionInvite: () => Promise.resolve([]),
    booksMyInvitations: () => Promise.resolve([]),
    booksContributionInvites: () => Promise.resolve([]),
    booksSubmitContribution: () => Promise.resolve(null),
    booksWithdrawContribution: () => Promise.resolve([]),
    booksMyContributions: () => Promise.resolve([]),
    booksBookContributions: () => Promise.resolve([]),
    booksDecideContribution: () => Promise.resolve([]),
