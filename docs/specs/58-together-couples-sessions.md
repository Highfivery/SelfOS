...
> **Status:** **Approved** — _last updated 2026-07-10_
>
...
| **H — Integrations & whole-app polish**                 | Joint challenges (marker parse-condition + twin mint + `groupId` + grounding surfacing + the strip tile); questionnaire SUGGEST artifact → compat seed path → alignment-report grounding; Home `together-session` provider (+ capability snapshot + provider unit); quiet-session offer (14d); person-delete reap; full-flow coherence walk across all phases + visual QA sweep vs. the mockups, both themes.                                                                                                                                                                                                                                                                                                                                                                            | E2E #7 (challenges + questionnaire loop) + #11 (person-delete reap, decrypt) + Home provider surfacing/dismiss + the full-matrix regression run.                                                                                                                                                                                                                                                                                                                                               |
