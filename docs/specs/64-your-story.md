...
### 18.2 Publish lifecycle — publish-diff + unpublish (#300)

Republish silently shrinks the reader's book; add a publish-diff preview (what readers gain/lose), an unpublish
action, and a guard/confirm against a silent shrink.
...
| B3-2  | #300  | Publish-diff preview + unpublish + no-silent-shrink confirm.                                                                                                                                                                                                                                                                | Core + bridge + RTL + E2E (diff shown; unpublish removes reader access; shrink confirms).                                                                                                                                                                                                                                                                                                                                                                              |
