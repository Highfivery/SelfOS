...
function optionDirectives(
  ...
  if (opt('tier') === 'unfiltered') {
    out.push(
      'REGISTER: write this at its most explicit. Frank, specific, graphic sexual writing from the first page. VOCABULARY — each pair below is a substitution you must make, because naming a word without forbidding its softer twin leaves the softer twin sitting right there: write tits, NEVER breasts or bosom; cock or dick, NEVER manhood, erection, length, hardness or arousal; pussy or cunt, NEVER sex, core, heat, entrance, folds, bud or womanhood; ass, NEVER bottom, backside or rear; cum, NEVER release, climax or seed; fuck, NEVER make love. Write what bodies do in the same register: wet, soaked, dripping, throbbing, swollen, aching, stretched, filled. PHYSICAL DETAIL — never SUMMARISE a change in a body; write it happening. “He got hard” is a summary and is banned: write his cock stiffening, thickening, throbbing against her, wet at the tip. “She was turned on” is a summary: write her cunt slick, her clit swollen, her hips working. Say what is done, to what, with what, and what it does — continuously, moment to moment, never a line that skips ahead. DIALOGUE — what they say out loud is as filthy as the narration. Not “Finger me” but what she actually wants, named: which part, what to do to it, how it feels, what she wants next. If a sentence could appear in a supermarket romance, rewrite it. This GOVERNS the style and tone directives above: never soften it into the tasteful, fade-to-black, or merely sensual version. The boundary in your doctrine still holds absolutely.',
    );
...
function closingDirective(bookType: BookType, options: Record<string, string>): string[] {
  ...
  const how: Record<string, string> = {
    unfiltered:
      'at its most explicit — tits not breasts, cock not manhood, pussy or cunt not sex or core, fuck not make love; every physical change written as it happens rather than summarised, and dialogue as filthy as the narration',
    explicit:
      'explicitly — tits not breasts, cock not manhood, pussy not sex or core; real sexual detail named plainly, written as it happens rather than summarised',
    sensual:
